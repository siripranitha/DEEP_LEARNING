...
from Configure import training_configs,configure
...
if __name__ == '__main__':
	...
	if model_and_run_configs.mode == 'train':
		...
		_, _, x_test, y_test = load_data(model_and_run_configs.data_dir)
		model.evaluate(x_test, y_test,model_and_run_configs.final_model_path)

	elif model_and_run_configs.mode == 'predict':
		...
		visualize(x_test[0], 'images/test.png')
